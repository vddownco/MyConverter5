...
<html>
    ...
    <section class="body1">
        ...
        <div class="gg"><span id="alert1">Download Youtube videos to MP4</span></div>
    </section>
    <section class="home">
...
<input type="text" id="inputtext" placeholder="Paste the Youtube URL">
                ...
                <div class="buttontext"  onclick="createContentinner()">
    ...
    <section id="characteristics">
        <div class="bulletkeys">
            ...
            <div class="listt">
                ...
                <ul>
                    <li class="greyy"><p><span class="listing">Download Youtube mp4, convert Youtube to high quality mp4: 720p, 480p, 360p.</span></p></li><br>
