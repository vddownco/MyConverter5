...
<html>
    ...
    <section class="body1">
        ...
        <div class="gg"><span id="alert1">Register for save downloads</span></div>
    </section>
    ...
    <form action="./CRUD/Logic/newuser.php" method="POST"></form>
    <section class="home">
        
        <div class="in-flex">
            <div class="container">
                <div class="linktextt">
<input type="text" name="email" id="inputtext" placeholder="Write your email">
                </div>
                <div>
    ...
    <section class="home">
        ...
        <div class="in-flex">
            <div class="container">
                <div class="linktextt">
<input type="text" name="name"  id="inputtext2" placeholder="Write a username">
    ...
    <section class="home">
        ...
        <div class="in-flex">
            <div class="container">
                <div class="linktextt">
<input type="text" name="password"  id="inputtext3" placeholder="Write your password">
    ...
    <div class="in-flex">
        <div class="title">
            <div class="bbuttontext"   onclick="enviarDatos()">
                    
        <div class="title">
            <div class="gg"><span id="alert2">Regis</span><span id="alert3">ter</span></div>
    ...
    <div class="in-flex">
        <div class="title">
            <div class="gg"><span id="alert1" onclick="cambiaventana(3)">Already have account?&nbsp;</span><span id="aalert2" onclick="cambiaventana(3)">Log&nbsp;</span><span id="aalert2">In</span></div>
        </div>
